...
<Columns cols={3}>
  <Card title="Garder sur un jugement" icon="gavel" href="/core/judgment-oracles">
    `ALLOW send WHEN judge.kind.p >= 0.90` : la politique lit la calibration, pas une confiance déclarée.
  </Card>
